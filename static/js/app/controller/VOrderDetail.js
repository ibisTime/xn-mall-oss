                            ...
                            */
                            ...
                            var html = '<ul>';
                                html += '<ul>' +
                                    ...
                                    '<div class="order-right-wrap clearfix"><div class="fl wp60 plr10">' +
                                    '<p class="tl line-tow pt6">' + text1 + data.reCardno + '</p>' +
                            ...
                            $("#totalAmount").html(base.formatMoney(data.amount*data.product.rate)+"菜狗币");
