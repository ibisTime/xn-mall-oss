...
define([ 'app/controller/base',
    ...
    var mobile ;
//  var flagHb = sessionStorage.getItem("flagHb")||"";
    ...
    function initWXSDK(data) {
        ...
        wx.ready(function() {
            ...
            wx.onMenuShareAppMessage({
                ...
                link: SHAKEURL+"/shake/share-receive.html?code="+hbCode+"&userReferee="+base.getUserId(), // 分享链接
            ...
            wx.onMenuShareTimeline({
                title: "菜狗商城,领取定向红包", // 分享标题
                desc: "菜狗商城,领取定向红包", // 分享描述
                link: SHAKEURL+"/shake/share-receive.html?code="+hbCode+"&userReferee="+mobile, // 分享链接
                imgUrl: "http://"+SHAKEURL+"/static/images/logo2.png", // 分享图标
                success: function() {
                    // 用户确认分享后执行的回调函数
                    shakeWin();
