...
public class CustomerController extends BaseController {
	...
	public Object addhuopin(
		...
		return userAO.addUser(loginName, mobile, idKind, idNo, realName, this
				.getSessionUser().getUserId(), this.getSessionUser()
				.getUserName(), remark, EUserKind.Goods.getCode(), pdf);
	}
	...
	public Object addjifen(
		...
		return userAO.addUser(loginName, mobile, idKind, idNo, realName, this
				.getSessionUser().getUserId(), this.getSessionUser()
				.getUserName(), remark, EUserKind.Integral.getCode(), pdf);
	}
	...
	public Object addzhongduan(
		...
		return userAO.addUser(loginName, mobile, idKind, idNo, realName, this
				.getSessionUser().getUserId(), this.getSessionUser()
				.getUserName(), remark, EUserKind.F1.getCode(), pdf);
	}
	...
	public Object queryCustomerPage(
		...
		return userAO.queryUserPage(loginName, EUserKind.F1.getCode(), level,
				userReferee, mobile, idKind, idNo, realName, null, status,
				null, start, limit, isGetAmount);
	}
	...
	public Object jiaMengPage(
			...
			@RequestParam(value = "start", required = false) String start,
			@RequestParam(value = "limit", required = false) String limit) {
		return userAO.queryUserPage(loginName, EUserKind.CaiGo.getCode(),
				level, this.getSessionUser().getUserId(), mobile, idKind, idNo,
				realName, null, status, null, start, limit, isGetAmount);
	}
	...
	public Object queryZhongduanPage(
		...
		return userAO.queryTerminalUserPage(this.getSessionUser().getUserId(),
				mobile, start, limit, isGetAmount);
	}
	...
	public Object queryCustomerList(
			...
			@RequestParam(value = "level", required = false) String level) {
		return userAO
				.queryUserList(loginName, EUserKind.F1.getCode(), level,
						userReferee, mobile, idKind, idNo, realName, null,
						status, null);
	}
	...
	public Object queryRolePage(
		...
		return BizConnecter.getBizData("805091",
