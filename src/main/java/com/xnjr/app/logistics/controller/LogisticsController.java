...
public class LogisticsController extends BaseController {
    ...
    public Object addLogistics(@RequestParam("code") String code,
        ...
        return logisticsAO.addLogistics(code, invoiceCode, company, deliveryDatetime, deliverer, goodsList);
    }
    
    // 物流单分页查询
    @RequestMapping(value = "/page", method = RequestMethod.GET)
    @ResponseBody
    public Object queryLogisticsPage(@RequestParam(value = "code", required = false) String code, 
        ...
        return logisticsAO.queryLogisticsPage(code, invoiceCode, deliveryDatetimeStart, 
        		deliveryDatetimeEnd, deliverer, userId, start, limit, orderColumn, orderDir);
    }
    ...
    @ResponseBody
    public Object queryStartCodeByModelCode(@RequestParam("modelCode") String modelCode) {
    ...
    @ResponseBody
    public Object queryGoodsPage(@RequestParam(value = "code", required = false) String code, 
            ...
            @RequestParam(value = "orderColumn", required = false) String orderColumn,
            @RequestParam(value = "orderDir", required = false) String orderDir) {
        return logisticsAO.queryGoodsPage(code, modelCode, logisticsCode, userId, start, limit, orderColumn, orderDir);
    }
}
