...
public interface ILogisticsAO {
	...
	// 物流信息录入
	Object addLogistics(String code, String invoiceCode, String company, String deliveryDatetime, 
			String deliverer, List<GoodsReq> goodsList);
	
	// 物流单分页查询
    Object queryLogisticsPage(String code, String invoiceCode, 
    		String deliveryDatetimeStart, String deliveryDatetimeEnd, String deliverer, 
    		String userId, String start, String limit, String orderColumn, String orderDir);
