...
//	initData();
	...
	$('#detailBtn').click(function() {
		...
		window.location.href = $("#basePath").val()+"/project/business_follow.htm?subjectCode="+selRecords[0].code;
	});
	// 编辑菜单绑定事件
	$('#subBtn').click(function() {
		...
		if(selRecords[0].status != '2'){
			alert("该项目状态不是已开始，进行中状态");
			return;
		}
		window.location.href = $("#basePath").val()+"/project/business_sub.htm?subjectCode="+selRecords[0].code;
	});
