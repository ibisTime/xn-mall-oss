...
$(function(){
	...
	$("#status").renderDropdown(Dict.getName('business_status'));
...
//	initData();
	...
	$('#detailBtn').click(function() {
		...
		window.location.href = $("#basePath").val()+"/project/business_detail.htm?businessCode="+selRecords[0].code+"&subjectCode="+selRecords[0].subjectCode+"&op=search";
	});
