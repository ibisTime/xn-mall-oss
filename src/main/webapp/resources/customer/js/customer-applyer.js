...
$(function(){
	...
	$('#checkBtn').click(function() {
		...
		selRecords[0].id+'&realName=' + encodeURIComponent(selRecords[0].realName) + 
		'&companyCode=' + selRecords[0].companyCode + '&sqghPicture=' + selRecords[0].sqghPicture + '&type=' + selRecords[0].type;
	});
