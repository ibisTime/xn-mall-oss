$(function() {
	...
	$('#subBtn').click(function() {
		...
		var url = $("#basePath").val()+"/user/replace/"+$("#operate").val();
...
function doGetDetailBack(res){
	if (res.success) {
			...
			$('#idKind').replaceWith($('<span>'+Dict.getIDKindName(res.data.idKind)+'</span>'));
